              ...
              {navItems.map((item, index) => (
                <Link key={item.name} href={item.href} legacyBehavior>
                  <motion.a
                    ...
                    transition={{ delay: 0.1 * index + 0.3 }}
                    whileHover={{ scale: 1.05, y: -2 }}
                    className={`cursor-pointer flex items-center space-x-2 px-4 py-2 rounded-lg transition-all duration-300 font-medium
                      ${
                        isActive(item.href)
                          ? "text-purple-600 dark:text-purple-400 underline underline-offset-4"
                          : `${getTextColor(theme, "secondary")} hover:${getTextColor(theme, "primary")} ${
                ...
                {navItems.map((item, index) => (
                  <Link key={item.name} href={item.href} legacyBehavior>
                    <motion.a
                      ...
                      transition={{ delay: 0.1 * index }}
                      onClick={() => setIsMobileMenuOpen(false)}
                      className={`cursor-pointer flex items-center space-x-3 px-4 py-3 rounded-lg transition-all duration-300 font-medium
                        ${
                          isActive(item.href)
                            ? "text-purple-600 dark:text-purple-400 underline underline-offset-4"
                            : `${getTextColor(theme, "secondary")} hover:${getTextColor(theme, "primary")} ${
